  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        style={{
          filter: isCharging ? `brightness(${1 + chargeLevel * 0.01}) saturate(${1 + chargeLevel * 0.02})` : 'none',
          transformStyle: 'preserve-3d',
          animation: isFlipping ? 'flip3d 1.5s ease-in-out' : 
                    isVibrating ? 'shake 0.3s ease-in-out' : undefined
        }}
      >
        <Avatar className={`w-32 h-32 border-4 transition-all duration-200 ${
          isFlipping ? 'animate-pulse border-yellow-400' : 
          showResult && coinResult === "heads" ? 'border-green-400 shadow-lg shadow-green-400/50' :
          showResult && coinResult === "tails" ? 'border-red-400 shadow-lg shadow-red-400/50' :
          ...
          <AvatarImage 
            ...
            className={`transition-all duration-500 ${
              showResult && coinResult === "heads" ? 'hue-rotate-90 saturate-150 brightness-110' :
              showResult && coinResult === "tails" ? 'hue-rotate-180 saturate-150 brightness-90 contrast-125' :
              ''
            }`}
          />
          <AvatarFallback className={`transition-all duration-500 ${
            showResult && coinResult === "heads" ? 'bg-green-100 text-green-800' :
            showResult && coinResult === "tails" ? 'bg-red-100 text-red-800' :
            ''
          }`}>GM</AvatarFallback>
        </Avatar>
          ...
          <>
            ...
            <div 
              ...
              style={{
                ...
                animation: chargeLevel > 50 ? 'chargeGlow 0.8s ease-in-out infinite' : undefined
              }}
            />
